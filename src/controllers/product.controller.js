...
const createProduct = asyncHandler(async (req, res) => {
  ...
  const mainImageCloudinary = await uploadOnCloudinary(mainImageLocalPath);

  const subImagesCloudinary = await uploadOnCloudinary(subImages);
